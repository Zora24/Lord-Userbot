...
# ========================= CONSTANTS ============================
AFKSTR = [
    f"**• ᴍᴀᴀꜰ ᴋᴀɴᴊᴇɴɢ {ALIVE_NAME} ꜱᴇᴅᴀɴɢ ᴀꜰᴋ!**",
    f"**• ᴍᴀᴀꜰ ᴋᴀɴᴊᴇɴɢ {ALIVE_NAME} ꜱᴇᴅᴀɴɢ ᴀꜰᴋ\n • ᴛᴜɴɢɢᴜ ꜱᴀᴍᴘᴀɪ ᴋᴀɴᴊᴇɴɢ ᴋᴇᴍʙᴀʟɪ ᴏɴʟɪɴᴇ!**",
    f"**• ᴋᴀɴᴊᴇɴɢ {ALIVE_NAME} ꜱᴇᴅᴀɴɢ ᴀꜰᴋ!\n • ᴛᴜɴɢɢᴜʟᴀʜ ꜱᴀᴍᴘᴀɪ ᴏɴʟɪɴᴇ!**",
    f"**• ᴍᴀᴀꜰ ᴋᴀɴᴊᴇɴɢ {ALIVE_NAME} ꜱᴇᴅᴀɴɢ ᴀꜰᴋ!**",
]
...
async def type_afk_is_not_true(notafk):
    ...
    if ISAFK:
        ISAFK = False
        msg = await notafk.respond("**ᴋᴀɴᴊᴇɴɢ ᴛᴇʟᴀʜ ᴋᴇᴍʙᴀʟɪ !!**")
        time.sleep(3)
        await msg.delete()
        ...
        if ISAFK:
            ...
            if mention.sender_id not in USERS:
                ...
                if USERS[mention.sender_id] % randint(2, 4) == 0:
                    if AFKREASON:
                        await mention.reply(f"𝗔 𝗙 𝗞 🌹\n **ᴋᴀɴᴊᴇɴɢ ᴍᴀꜱɪʜ ᴀꜰᴋ** {afk_since} **ʏᴀɴɢ ʟᴀʟᴜ.**\
                            \n**• ᴀʟᴀꜱᴀɴ :** `{AFKREASON}`")
                    else:
                        await mention.reply(str(choice(AFKSTR)))
