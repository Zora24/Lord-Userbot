...
# ========================= CONSTANTS ============================
AFKSTR = [
    f"**Maaf Gaiss {ALIVE_NAME} Lagi Stres!**",
    f"**Maaf Gaiss {ALIVE_NAME} Lagi stress\n Tunggu Sampai Dia Kembali Waras!**",
    f"**Tuan {ALIVE_NAME} Lagi Stress\n Tunggulah Sampai Waras**",
    f"**Maaf Gaiss {ALIVE_NAME} Lagi Stress!**",
]
...
async def set_afk(afk_e):
    ...
    if string:
        AFKREASON = string
        await afk_e.edit(f"**✘ GILA!**\n**Gua Lagi Stress**\
        \n☛ **Alasan:** `{string}`")
    else:
        await afk_e.edit("**✘ GILA!**\n**Gua  Lagi  Stress**")
    if user.last_name:
        await afk_e.client(UpdateProfileRequest(first_name=user.first_name, last_name=user.last_name + "【STRES】"))
    else:
        await afk_e.client(UpdateProfileRequest(first_name=user.first_name, last_name="【STRES】"))
    if BOTLOG:
...
async def type_afk_is_not_true(notafk):
    ...
    if ISAFK:
        ISAFK = False
        msg = await notafk.respond("**Akhirnya Gua Waras!**")
        time.sleep(3)
        await msg.delete()
        ...
        if BOTLOG:
            await notafk.client.send_message(
                ...
                str(len(USERS)) + " Obrolan Saat Anda Stress",
            )
            for i in USERS:
