...
async def _(event):
    ...
    if cmd == "":
        ...
        await lord.delete()
        await bot.send_file(event.chat_id, "CAADAQADLQADnjOcH39IqwyR6Q_0Ag")
    elif cmd == "n":
        await lord.edit(
        ...
        await asyncio.sleep(4)
        await lord.delete()
        await bot.send_file(event.chat_id, "CAADAQADQAADnjOcH-WOkB8DEctJAg")
